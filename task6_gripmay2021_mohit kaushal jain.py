...
wd = webdriver.Edge(executable_path="C:\\Users\\Mohit\Downloads\\edgedriver_win64\\msedgedriver.exe")
print(wd.title)
...
try:
    ...
    time.sleep(3)
    wd.find_element_by_name('Name').send_keys('Mohit Jain')
    time.sleep(3)
    wd.find_element_by_name('Email').send_keys('99mohitjain@gmail.com')
    time.sleep(3)
